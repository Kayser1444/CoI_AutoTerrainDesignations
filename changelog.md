v0.5.0 [unreleased]
* Fixed: useful-height hull pruning now permits generated V1 centers up to `0.5` and V2 centers up to `1.0` below the lower hull, leaving room for the flat landing needed to turn a descending ramp toward a low fixed goal. The upper hull is unchanged.
