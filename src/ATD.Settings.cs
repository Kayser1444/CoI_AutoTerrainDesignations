...
namespace AutoTerrainDesignations
{
    public static partial class AutoDepthDesignation
    {
        ...
        internal static string BuildSettingsJson()
        {
            ...
            sb.AppendLine();
            sb.AppendLine("  \"_comment_accessManagerInteractiveFrameBudgetMs\": \"Managed direct-interaction search budget per rendered frame during normal play. Reserved for interactive migration. Range: 1-300. Default: 15.\",");
            sb.AppendLine($"  \"accessManagerInteractiveFrameBudgetMs\": {AutoTerrainDesignationsMod.AccessManagerInteractiveFrameBudgetMs},");
            sb.AppendLine();
            sb.AppendLine("  \"_comment_accessManagerPausedMaxFrameBudgetMs\": \"Maximum managed access-search budget per rendered frame while paused. Range: 1-300. Default: 30.\",");
