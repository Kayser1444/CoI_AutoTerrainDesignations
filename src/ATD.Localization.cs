...
namespace AutoTerrainDesignations
{
    ...
    internal static class AtdLocalization
    {
        ...
        public static LocStr CornerPlanarTip =
            Loc.Str("toolbox.corner_planar.tooltip", "Planar corner: place a diagonal plane ramp.", "Tooltip on the planar corner toolbox item.");
